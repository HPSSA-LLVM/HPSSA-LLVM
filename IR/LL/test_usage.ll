...
_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit105: ; preds = %if.end.i.i.i101, %if.then.i4.i.i97
  ...
  %tau4 = call i8 (...) @llvm.tau.i8(i8 %retval.0.i.i.i102, i8 %call.i.i.i100)
  %tau1 = call i8 (...) @llvm.tau.i8(i8 %tau, i8 %i6)
  %call1.i103 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSo3putEc(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) %call21, i8 signext %tau4)
  br label %if.end33.sink.split
...
if.end33.sink.split:                              ; preds = %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit105, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit85
  ...
  %tau5 = call %"class.std::basic_ostream"* (...) @"llvm.tau.p0s_class.std::basic_ostreams"(%"class.std::basic_ostream"* %call1.i103.sink, %"class.std::basic_ostream"* %call1.i103)
  %tau2 = call i8 (...) @llvm.tau.i8(i8 %tau, i8 %i6)
  %call.i.i104 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSo5flushEv(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) %tau5)
  br label %if.end33
...
_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit125: ; preds = %if.end.i.i.i121, %if.then.i4.i.i117
  ...
  %tau6 = call i8 (...) @llvm.tau.i8(i8 %retval.0.i.i.i122, i8 %call.i.i.i120)
  %tau3 = call i8 (...) @llvm.tau.i8(i8 %tau, i8 %i6)
  %call1.i123 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSo3putEc(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) %call34, i8 signext %tau6)
...
; Function Attrs: nofree nosync nounwind willreturn
declare %"class.std::basic_ostream"* @"llvm.tau.p0s_class.std::basic_ostreams"(...) #6
