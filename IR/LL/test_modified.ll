...
for.cond.cleanup:                                 ; preds = %for.body, %entry
  %temp.0.lcssa = phi i32 [ 1, %entry ], [ %mul.phi.tau, %for.body ], !dbg !990
  %temp.0.lcssa.tau = phi i32 [ %temp.0.lcssa, %for.cond.cleanup ]
  ret i32 %temp.0.lcssa.tau, !dbg !996
...
for.body:                                         ; preds = %for.body.for.body_crit_edge, %entry.for.body_crit_edge
  ...
  %i.08.tau = phi i32 [ %i.08, %for.body ]
  %mul.phi.tau = phi i32 [ %mul.phi, %for.body ]
  call void @llvm.dbg.value(metadata i32 %i.08.tau, metadata !988, metadata !DIExpression()), !dbg !991
  call void @llvm.dbg.value(metadata i32 undef, metadata !987, metadata !DIExpression()), !dbg !990
  call void @llvm.dbg.value(metadata i32 %mul.phi.tau, metadata !987, metadata !DIExpression()), !dbg !990
  %inc = add nuw i32 %i.08.tau, 1, !dbg !997
  call void @llvm.dbg.value(metadata i32 %inc, metadata !988, metadata !DIExpression()), !dbg !991
  %exitcond.not = icmp eq i32 %i.08.tau, %val, !dbg !992
  br i1 %exitcond.not, label %for.cond.cleanup, label %for.body.for.body_crit_edge, !dbg !994, !llvm.loop !998

for.body.for.body_crit_edge:                      ; preds = %for.body
  %mul.0 = mul nsw i32 %inc, %mul.phi.tau, !dbg !995
  br label %for.body, !dbg !994
}
...
entry:
  ...
  %i = call i32 @__cxa_atexit(void (i8*)* bitcast (void (%"class.std::ios_base::Init"*)* @_ZNSt8ios_base4InitD1Ev to void (i8*)*), i8* getelementptr inbounds (%"class.std::ios_base::Init", %"class.std::ios_base::Init"* @_ZStL8__ioinit, i64 0, i32 0), i8* nonnull @__dso_handle) #6, !dbg !1008
  ret void
}
...
attributes #3 = { nofree norecurse nosync nounwind readnone uwtable willreturn mustprogress "frame-pointer"="none" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
attributes #4 = { uwtable "frame-pointer"="none" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
attributes #5 = { nofree nosync nounwind readnone speculatable willreturn }
attributes #6 = { nounwind }

!llvm.dbg.cu = !{!28}
!llvm.module.flags = !{!978, !979, !980, !981, !982}
!llvm.ident = !{!983}
...
!118 = !DIFile(filename: "Downloads/llvm-project/build/lib/clang/13.0.0/include/stddef.h", directory: "/home/mabhay")
...
!977 = !{!929, !165}
!978 = !{i32 7, !"Dwarf Version", i32 4}
!979 = !{i32 2, !"Debug Info Version", i32 3}
!980 = !{i32 1, !"wchar_size", i32 4}
!981 = !{i32 7, !"PIC Level", i32 2}
!982 = !{i32 7, !"uwtable", i32 1}
!983 = !{!"clang version 13.0.0 (https://github.com/llvm/llvm-project.git 1e344ce4f3fac4beb5e23e04dc3dd59398125956)"}
