...
entry:
  ...
  call void @llvm.dbg.label(metadata !991), !dbg !1001
  %i = bitcast i32* %a to i8*, !dbg !1002
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %i) #8, !dbg !1002
  %i1 = bitcast i32* %b to i8*, !dbg !1002
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %i1) #8, !dbg !1002
  call void @llvm.dbg.value(metadata i32* %a, metadata !987, metadata !DIExpression(DW_OP_deref)), !dbg !1003
  %call = call nonnull align 8 dereferenceable(16) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* nonnull align 8 dereferenceable(16) @_ZSt3cin, i32* nonnull align 4 dereferenceable(4) %a), !dbg !1004
  call void @llvm.dbg.value(metadata i32* %b, metadata !988, metadata !DIExpression(DW_OP_deref)), !dbg !1003
  %call2 = call nonnull align 8 dereferenceable(16) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* nonnull align 8 dereferenceable(16) %call, i32* nonnull align 4 dereferenceable(4) %b), !dbg !1005
  %i2 = load i32, i32* %a, align 4, !dbg !1006, !tbaa !1008
  call void @llvm.dbg.value(metadata i32 %i2, metadata !987, metadata !DIExpression()), !dbg !1003
  %cmp3 = icmp slt i32 %i2, -1
  br i1 %cmp3, label %entry_2, label %entry_1, !dbg !1012

entry_1:                                          ; preds = %entry
  call void @llvm.dbg.label(metadata !992), !dbg !1013
  %mul = mul nsw i32 %i2, 5, !dbg !1014
  call void @llvm.dbg.value(metadata i32 %mul, metadata !987, metadata !DIExpression()), !dbg !1003
  br label %while_start_label.preheader, !dbg !1015

entry_2:                                          ; preds = %entry
  call void @llvm.dbg.label(metadata !993), !dbg !1016
  %div = sdiv i32 %i2, 4, !dbg !1017
  call void @llvm.dbg.value(metadata i32 %div, metadata !987, metadata !DIExpression()), !dbg !1003
  br label %while_start_label.preheader, !dbg !1018

while_start_label.preheader:                      ; preds = %entry_2, %entry_1
  %storemerge21 = phi i32 [ %mul, %entry_1 ], [ %div, %entry_2 ], !dbg !1003
  store i32 %storemerge21, i32* %a, align 4, !dbg !1003, !tbaa !1008
  %i3 = bitcast i32* %c to i8*
  %i4 = bitcast i32* %d to i8*
  br label %while_start_label, !dbg !1019

while_start_label:                                ; preds = %while_end_label, %while_start_label.preheader
  call void @llvm.dbg.label(metadata !994), !dbg !1020
  %i5 = load i32, i32* %a, align 4, !dbg !1021, !tbaa !1008
  call void @llvm.dbg.value(metadata i32 %i5, metadata !987, metadata !DIExpression()), !dbg !1003
  %sub = add nsw i32 %i5, -4, !dbg !1021
  call void @llvm.dbg.value(metadata i32 %sub, metadata !987, metadata !DIExpression()), !dbg !1003
  store i32 %sub, i32* %a, align 4, !dbg !1021, !tbaa !1008
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %i3) #8, !dbg !1022
  call void @llvm.dbg.value(metadata i32* %c, metadata !989, metadata !DIExpression(DW_OP_deref)), !dbg !1003
  %call6 = call nonnull align 8 dereferenceable(16) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* nonnull align 8 dereferenceable(16) @_ZSt3cin, i32* nonnull align 4 dereferenceable(4) %c), !dbg !1023
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %i4) #8, !dbg !1024
  call void @llvm.dbg.value(metadata i32* %d, metadata !990, metadata !DIExpression(DW_OP_deref)), !dbg !1003
  %call7 = call nonnull align 8 dereferenceable(16) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* nonnull align 8 dereferenceable(16) @_ZSt3cin, i32* nonnull align 4 dereferenceable(4) %d), !dbg !1025
  %i6 = load i32, i32* %a, align 4, !dbg !1026, !tbaa !1008
  call void @llvm.dbg.value(metadata i32 %i6, metadata !987, metadata !DIExpression()), !dbg !1003
  %cmp8 = icmp slt i32 %i6, 5, !dbg !1027
  %i7 = load i32, i32* %d, align 4, !dbg !1028, !tbaa !1008
  call void @llvm.dbg.value(metadata i32 %i7, metadata !990, metadata !DIExpression()), !dbg !1003
  call void @llvm.dbg.value(metadata i32 %i7, metadata !990, metadata !DIExpression()), !dbg !1003
  br i1 %cmp8, label %while_if_label, label %while_else_label, !dbg !1019

while_if_label:                                   ; preds = %while_start_label
  call void @llvm.dbg.label(metadata !995), !dbg !1029
  %mul10 = mul nsw i32 %i7, 5, !dbg !1030
  call void @llvm.dbg.value(metadata i32 %mul10, metadata !990, metadata !DIExpression()), !dbg !1003
  store i32 %mul10, i32* %d, align 4, !dbg !1030, !tbaa !1008
  call void @llvm.dbg.value(metadata i32 %i6, metadata !987, metadata !DIExpression()), !dbg !1003
  %mul11 = shl nsw i32 %i6, 1, !dbg !1031
  call void @llvm.dbg.value(metadata i32 %mul11, metadata !987, metadata !DIExpression()), !dbg !1003
  br label %while_end_label, !dbg !1032

while_else_label:                                 ; preds = %while_start_label
  %tau = call i32 (...) @llvm.tau.i32(i32 %storemerge21, i32 %div)
  call void @llvm.dbg.label(metadata !998), !dbg !1033
  %mul12 = mul nsw i32 %i7, 3, !dbg !1034
  call void @llvm.dbg.value(metadata i32 %mul12, metadata !990, metadata !DIExpression()), !dbg !1003
  store i32 %mul12, i32* %d, align 4, !dbg !1034, !tbaa !1008
  call void @llvm.dbg.value(metadata i32 %i6, metadata !987, metadata !DIExpression()), !dbg !1003
  %mul13 = mul nsw i32 %i6, 6, !dbg !1035
  call void @llvm.dbg.value(metadata i32 %mul13, metadata !987, metadata !DIExpression()), !dbg !1003
  br label %while_end_label, !dbg !1036

while_end_label:                                  ; preds = %while_else_label, %while_if_label
  %storemerge = phi i32 [ %mul13, %while_else_label ], [ %mul11, %while_if_label ], !dbg !1028
  store i32 %storemerge, i32* %a, align 4, !dbg !1028, !tbaa !1008
  call void @llvm.dbg.label(metadata !1000), !dbg !1037
  %i8 = load i32, i32* %d, align 4, !dbg !1038, !tbaa !1008
  call void @llvm.dbg.value(metadata i32 %i8, metadata !990, metadata !DIExpression()), !dbg !1003
  %sub14 = add nsw i32 %i8, -4, !dbg !1038
  call void @llvm.dbg.value(metadata i32 %sub14, metadata !990, metadata !DIExpression()), !dbg !1003
  store i32 %sub14, i32* %d, align 4, !dbg !1038, !tbaa !1008
  %i9 = load i32, i32* %c, align 4, !dbg !1039, !tbaa !1008
  call void @llvm.dbg.value(metadata i32 %i9, metadata !989, metadata !DIExpression()), !dbg !1003
  %dec = add nsw i32 %i9, -1, !dbg !1039
  call void @llvm.dbg.value(metadata i32 %dec, metadata !989, metadata !DIExpression()), !dbg !1003
  store i32 %dec, i32* %c, align 4, !dbg !1039, !tbaa !1008
  %cmp15 = icmp sgt i32 %i9, 1, !dbg !1040
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %i4) #8, !dbg !1042
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %i3) #8, !dbg !1042
  br i1 %cmp15, label %while_start_label, label %cleanup19

cleanup19:                                        ; preds = %while_end_label
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %i1) #8, !dbg !1042
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %i) #8, !dbg !1042
  ret i32 0, !dbg !1042
}
...
define internal void @_GLOBAL__sub_I_test.cpp() #6 section ".text.startup" !dbg !1043 {
entry:
  call void @_ZNSt8ios_base4InitC1Ev(%"class.std::ios_base::Init"* nonnull align 1 dereferenceable(1) @_ZStL8__ioinit), !dbg !1045
  %i = call i32 @__cxa_atexit(void (i8*)* bitcast (void (%"class.std::ios_base::Init"*)* @_ZNSt8ios_base4InitD1Ev to void (i8*)*), i8* getelementptr inbounds (%"class.std::ios_base::Init", %"class.std::ios_base::Init"* @_ZStL8__ioinit, i64 0, i32 0), i8* nonnull @__dso_handle) #8, !dbg !1049
  ret void
}
...
!977 = !{!929, !165}
!978 = !DIImportedEntity(tag: DW_TAG_imported_module, scope: !28, entity: !2, file: !29, line: 2)
...
!985 = distinct !DISubprogram(name: "main", scope: !29, file: !29, line: 3, type: !669, scopeLine: 3, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !28, retainedNodes: !986)
!986 = !{!987, !988, !989, !990, !991, !992, !993, !994, !995, !998, !1000}
!987 = !DILocalVariable(name: "a", scope: !985, file: !29, line: 7, type: !11)
!988 = !DILocalVariable(name: "b", scope: !985, file: !29, line: 7, type: !11)
!989 = !DILocalVariable(name: "c", scope: !985, file: !29, line: 42, type: !11)
!990 = !DILocalVariable(name: "d", scope: !985, file: !29, line: 44, type: !11)
!991 = !DILabel(scope: !985, name: "entry", file: !29, line: 6)
!992 = !DILabel(scope: !985, name: "entry_1", file: !29, line: 17)
!993 = !DILabel(scope: !985, name: "entry_2", file: !29, line: 21)
!994 = !DILabel(scope: !985, name: "while_start_label", file: !29, line: 40)
!995 = !DILabel(scope: !996, name: "while_if_label", file: !29, line: 48)
!996 = distinct !DILexicalBlock(scope: !997, file: !29, line: 46, column: 14)
!997 = distinct !DILexicalBlock(scope: !985, file: !29, line: 46, column: 7)
!998 = !DILabel(scope: !999, name: "while_else_label", file: !29, line: 55)
!999 = distinct !DILexicalBlock(scope: !997, file: !29, line: 53, column: 10)
!1000 = !DILabel(scope: !985, name: "while_end_label", file: !29, line: 62)
!1001 = !DILocation(line: 6, column: 1, scope: !985)
!1002 = !DILocation(line: 7, column: 3, scope: !985)
!1003 = !DILocation(line: 0, scope: !985)
!1004 = !DILocation(line: 8, column: 7, scope: !985)
!1005 = !DILocation(line: 8, column: 12, scope: !985)
!1006 = !DILocation(line: 9, column: 7, scope: !1007)
!1007 = distinct !DILexicalBlock(scope: !985, file: !29, line: 9, column: 7)
!1008 = !{!1009, !1009, i64 0}
!1009 = !{!"int", !1010, i64 0}
!1010 = !{!"omnipotent char", !1011, i64 0}
!1011 = !{!"Simple C++ TBAA"}
!1012 = !DILocation(line: 9, column: 7, scope: !985)
!1013 = !DILocation(line: 17, column: 1, scope: !985)
!1014 = !DILocation(line: 18, column: 5, scope: !985)
!1015 = !DILocation(line: 19, column: 3, scope: !985)
!1016 = !DILocation(line: 21, column: 1, scope: !985)
!1017 = !DILocation(line: 22, column: 5, scope: !985)
!1018 = !DILocation(line: 23, column: 3, scope: !985)
!1019 = !DILocation(line: 46, column: 7, scope: !985)
!1020 = !DILocation(line: 40, column: 1, scope: !985)
!1021 = !DILocation(line: 41, column: 5, scope: !985)
!1022 = !DILocation(line: 42, column: 3, scope: !985)
!1023 = !DILocation(line: 43, column: 7, scope: !985)
!1024 = !DILocation(line: 44, column: 3, scope: !985)
!1025 = !DILocation(line: 45, column: 7, scope: !985)
!1026 = !DILocation(line: 46, column: 7, scope: !997)
!1027 = !DILocation(line: 46, column: 9, scope: !997)
!1028 = !DILocation(line: 0, scope: !997)
!1029 = !DILocation(line: 48, column: 3, scope: !996)
!1030 = !DILocation(line: 49, column: 7, scope: !996)
!1031 = !DILocation(line: 50, column: 7, scope: !996)
!1032 = !DILocation(line: 51, column: 5, scope: !996)
!1033 = !DILocation(line: 55, column: 3, scope: !999)
!1034 = !DILocation(line: 56, column: 7, scope: !999)
!1035 = !DILocation(line: 57, column: 7, scope: !999)
!1036 = !DILocation(line: 58, column: 5, scope: !999)
!1037 = !DILocation(line: 62, column: 1, scope: !985)
!1038 = !DILocation(line: 63, column: 5, scope: !985)
!1039 = !DILocation(line: 64, column: 4, scope: !985)
!1040 = !DILocation(line: 65, column: 8, scope: !1041)
!1041 = distinct !DILexicalBlock(scope: !985, file: !29, line: 65, column: 7)
!1042 = !DILocation(line: 70, column: 1, scope: !985)
!1043 = distinct !DISubprogram(linkageName: "_GLOBAL__sub_I_test.cpp", scope: !29, file: !29, type: !1044, flags: DIFlagArtificial | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !28, retainedNodes: !30)
!1044 = !DISubroutineType(types: !30)
!1045 = !DILocation(line: 74, column: 25, scope: !1046, inlinedAt: !1048)
!1046 = !DILexicalBlockFile(scope: !1047, file: !3, discriminator: 0)
!1047 = distinct !DISubprogram(name: "__cxx_global_var_init", scope: !29, file: !29, type: !582, flags: DIFlagArtificial | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !28, retainedNodes: !30)
!1048 = distinct !DILocation(line: 0, scope: !1043)
!1049 = !DILocation(line: 0, scope: !1047, inlinedAt: !1048)
