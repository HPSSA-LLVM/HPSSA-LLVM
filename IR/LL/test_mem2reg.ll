...
entry:
  ...
  %i2 = load i32, i32* %a, align 4, !dbg !999, !tbaa !1001
  call void @llvm.dbg.value(metadata i32 %i2, metadata !987, metadata !DIExpression()), !dbg !996
  %cmp = icmp sgt i32 %i2, 5, !dbg !1005
  br i1 %cmp, label %if.then, label %if.else, !dbg !1006

if.then:                                          ; preds = %entry
  %mul = mul nsw i32 %i2, 9, !dbg !1007
  ...
  %i3 = load i32, i32* %b, align 4, !dbg !1011, !tbaa !1001
  call void @llvm.dbg.value(metadata i32 %i3, metadata !988, metadata !DIExpression()), !dbg !996
  %mul2 = mul nsw i32 %i3, 3, !dbg !1012
...
if.else:                                          ; preds = %entry
  %add4 = add nsw i32 %i2, 8, !dbg !1015
  ...
  %i4 = load i32, i32* %b, align 4, !dbg !1018, !tbaa !1001
  call void @llvm.dbg.value(metadata i32 %i4, metadata !988, metadata !DIExpression()), !dbg !996
  %add5 = add nsw i32 %i4, 9, !dbg !1019
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  %add6 = add nsw i32 %i5, 7, !dbg !1022
...
if.else10:                                        ; preds = %if.end
  call void @llvm.dbg.value(metadata i32 %add6, metadata !987, metadata !DIExpression()), !dbg !996
  %cmp11 = icmp sgt i32 %i5, 2, !dbg !1028
  br i1 %cmp11, label %if.then12, label %if.else30, !dbg !1029

if.then12:                                        ; preds = %if.else10
  %add13 = add nsw i32 %i5, 14, !dbg !1030
...
if.end27:                                         ; preds = %if.else22, %if.then19
  ...
  %add28 = add nsw i32 %i6, %storemerge48, !dbg !1054
...
if.else30:                                        ; preds = %if.else10
  %add31 = add nsw i32 %i5, 12, !dbg !1059
...
if.then34:                                        ; preds = %if.else30
  %add35 = add nsw i32 %i5, 17, !dbg !1066
...
new_label:                                        ; preds = %if.then34, %if.else37, %if.then12
  ...
  %add41 = add nsw i32 %i7, 7, !dbg !1079
  ...
  %i8 = load i32, i32* %b, align 4, !dbg !1081, !tbaa !1001
  call void @llvm.dbg.value(metadata i32 %i8, metadata !988, metadata !DIExpression()), !dbg !996
  %add42 = add nsw i32 %i8, 6, !dbg !1082
...
!85 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "_IO_marker", file: !68, line: 36, flags: DIFlagFwdDecl | DIFlagNonTrivial, identifier: "_ZTS10_IO_marker")
...
!109 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "_IO_codecvt", file: !68, line: 37, flags: DIFlagFwdDecl | DIFlagNonTrivial, identifier: "_ZTS11_IO_codecvt")
...
!112 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "_IO_wide_data", file: !68, line: 38, flags: DIFlagFwdDecl | DIFlagNonTrivial, identifier: "_ZTS13_IO_wide_data")
...
!258 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "tm", file: !57, line: 83, flags: DIFlagFwdDecl | DIFlagNonTrivial, identifier: "_ZTS2tm")
...
!426 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "type_info", scope: !2, file: !427, line: 88, size: 128, flags: DIFlagFwdDecl | DIFlagNonTrivial, identifier: "_ZTSSt9type_info")
...
!517 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "lconv", file: !518, line: 51, size: 768, flags: DIFlagFwdDecl, identifier: "_ZTS5lconv")
...
!572 = distinct !DICompositeType(tag: DW_TAG_structure_type, file: !568, line: 58, size: 64, flags: DIFlagFwdDecl, identifier: "_ZTS5div_t")
...
!759 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "_G_fpos_t", file: !758, line: 10, size: 128, flags: DIFlagFwdDecl, identifier: "_ZTS9_G_fpos_t")
