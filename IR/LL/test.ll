...
entry:
  ...
  %vtable.i = load i8*, i8** %0, align 8, !tbaa !4
  ...
  %4 = load %"class.std::ctype"*, %"class.std::ctype"** %3, align 8, !tbaa !7
...
_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i: ; preds = %entry
  ...
  %5 = load i8, i8* %_M_widen_ok.i.i.i, align 8, !tbaa !12
...
if.then.i4.i.i:                                   ; preds = %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i
  ...
  %6 = load i8, i8* %arrayidx.i.i.i, align 1, !tbaa !14
...
if.end.i.i.i:                                     ; preds = %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i
  ...
  %vtable.i.i.i = load i8 (%"class.std::ctype"*, i8)**, i8 (%"class.std::ctype"*, i8)*** %7, align 8, !tbaa !4
...
if.else9:                                         ; preds = %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit
  ...
  %9 = bitcast %"class.std::basic_ostream"* %call11 to i8**
  %vtable.i66 = load i8*, i8** %9, align 8, !tbaa !4
  %vbase.offset.ptr.i67 = getelementptr i8, i8* %vtable.i66, i64 -24
  %10 = bitcast i8* %vbase.offset.ptr.i67 to i64*
  %vbase.offset.i68 = load i64, i64* %10, align 8
  %11 = bitcast %"class.std::basic_ostream"* %call11 to i8*
  %add.ptr.i69 = getelementptr inbounds i8, i8* %11, i64 %vbase.offset.i68
  %_M_ctype.i.i70 = getelementptr inbounds i8, i8* %add.ptr.i69, i64 240
  %12 = bitcast i8* %_M_ctype.i.i70 to %"class.std::ctype"**
  %13 = load %"class.std::ctype"*, %"class.std::ctype"** %12, align 8, !tbaa !7
  %tobool.not.i.i.i71 = icmp eq %"class.std::ctype"* %13, null
...
_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i75: ; preds = %if.else9
  %_M_widen_ok.i.i.i73 = getelementptr inbounds %"class.std::ctype", %"class.std::ctype"* %13, i64 0, i32 8
  %14 = load i8, i8* %_M_widen_ok.i.i.i73, align 8, !tbaa !12
  %tobool.not.i3.i.i74 = icmp eq i8 %14, 0
...
if.then.i4.i.i77:                                 ; preds = %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i75
  %arrayidx.i.i.i76 = getelementptr inbounds %"class.std::ctype", %"class.std::ctype"* %13, i64 0, i32 9, i64 10
  %15 = load i8, i8* %arrayidx.i.i.i76, align 1, !tbaa !14
...
if.end.i.i.i81:                                   ; preds = %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i75
  ...
  %vtable.i.i.i78 = load i8 (%"class.std::ctype"*, i8)**, i8 (%"class.std::ctype"*, i8)*** %16, align 8, !tbaa !4
  %vfn.i.i.i79 = getelementptr inbounds i8 (%"class.std::ctype"*, i8)*, i8 (%"class.std::ctype"*, i8)** %vtable.i.i.i78, i64 6
  %17 = load i8 (%"class.std::ctype"*, i8)*, i8 (%"class.std::ctype"*, i8)** %vfn.i.i.i79, align 8
  %call.i.i.i80 = call signext i8 %17(%"class.std::ctype"* nonnull align 8 dereferenceable(570) %13, i8 signext 10)
  br label %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit85

_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit85: ; preds = %if.then.i4.i.i77, %if.end.i.i.i81
  %retval.0.i.i.i82 = phi i8 [ %15, %if.then.i4.i.i77 ], [ %call.i.i.i80, %if.end.i.i.i81 ]
...
if.then18:                                        ; preds = %if.else14
  ...
  %vtable.i86 = load i8*, i8** %18, align 8, !tbaa !4
  %vbase.offset.ptr.i87 = getelementptr i8, i8* %vtable.i86, i64 -24
  %19 = bitcast i8* %vbase.offset.ptr.i87 to i64*
  %vbase.offset.i88 = load i64, i64* %19, align 8
  %20 = bitcast %"class.std::basic_ostream"* %call21 to i8*
  %add.ptr.i89 = getelementptr inbounds i8, i8* %20, i64 %vbase.offset.i88
  %_M_ctype.i.i90 = getelementptr inbounds i8, i8* %add.ptr.i89, i64 240
  %21 = bitcast i8* %_M_ctype.i.i90 to %"class.std::ctype"**
  %22 = load %"class.std::ctype"*, %"class.std::ctype"** %21, align 8, !tbaa !7
  %tobool.not.i.i.i91 = icmp eq %"class.std::ctype"* %22, null
...
_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i95: ; preds = %if.then18
  %_M_widen_ok.i.i.i93 = getelementptr inbounds %"class.std::ctype", %"class.std::ctype"* %22, i64 0, i32 8
  %23 = load i8, i8* %_M_widen_ok.i.i.i93, align 8, !tbaa !12
  %tobool.not.i3.i.i94 = icmp eq i8 %23, 0
...
if.then.i4.i.i97:                                 ; preds = %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i95
  %arrayidx.i.i.i96 = getelementptr inbounds %"class.std::ctype", %"class.std::ctype"* %22, i64 0, i32 9, i64 10
  %24 = load i8, i8* %arrayidx.i.i.i96, align 1, !tbaa !14
...
if.end.i.i.i101:                                  ; preds = %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i95
  ...
  %vtable.i.i.i98 = load i8 (%"class.std::ctype"*, i8)**, i8 (%"class.std::ctype"*, i8)*** %25, align 8, !tbaa !4
  %vfn.i.i.i99 = getelementptr inbounds i8 (%"class.std::ctype"*, i8)*, i8 (%"class.std::ctype"*, i8)** %vtable.i.i.i98, i64 6
  %26 = load i8 (%"class.std::ctype"*, i8)*, i8 (%"class.std::ctype"*, i8)** %vfn.i.i.i99, align 8
  %call.i.i.i100 = call signext i8 %26(%"class.std::ctype"* nonnull align 8 dereferenceable(570) %22, i8 signext 10)
  br label %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit105

_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit105: ; preds = %if.then.i4.i.i97, %if.end.i.i.i101
  %retval.0.i.i.i102 = phi i8 [ %24, %if.then.i4.i.i97 ], [ %call.i.i.i100, %if.end.i.i.i101 ]
...
if.end33.sink.split:                              ; preds = %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit85, %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit105
...
if.end33:                                         ; preds = %if.end33.sink.split, %if.else14
  ...
  %27 = bitcast %"class.std::basic_ostream"* %call34 to i8**
  %vtable.i106 = load i8*, i8** %27, align 8, !tbaa !4
  %vbase.offset.ptr.i107 = getelementptr i8, i8* %vtable.i106, i64 -24
  %28 = bitcast i8* %vbase.offset.ptr.i107 to i64*
  %vbase.offset.i108 = load i64, i64* %28, align 8
  %29 = bitcast %"class.std::basic_ostream"* %call34 to i8*
  %add.ptr.i109 = getelementptr inbounds i8, i8* %29, i64 %vbase.offset.i108
  %_M_ctype.i.i110 = getelementptr inbounds i8, i8* %add.ptr.i109, i64 240
  %30 = bitcast i8* %_M_ctype.i.i110 to %"class.std::ctype"**
  %31 = load %"class.std::ctype"*, %"class.std::ctype"** %30, align 8, !tbaa !7
  %tobool.not.i.i.i111 = icmp eq %"class.std::ctype"* %31, null
...
_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i115: ; preds = %if.end33
  %_M_widen_ok.i.i.i113 = getelementptr inbounds %"class.std::ctype", %"class.std::ctype"* %31, i64 0, i32 8
  %32 = load i8, i8* %_M_widen_ok.i.i.i113, align 8, !tbaa !12
...
if.then.i4.i.i117:                                ; preds = %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i115
  %arrayidx.i.i.i116 = getelementptr inbounds %"class.std::ctype", %"class.std::ctype"* %31, i64 0, i32 9, i64 10
  %33 = load i8, i8* %arrayidx.i.i.i116, align 1, !tbaa !14
...
if.end.i.i.i121:                                  ; preds = %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i115
  ...
  %vtable.i.i.i118 = load i8 (%"class.std::ctype"*, i8)**, i8 (%"class.std::ctype"*, i8)*** %34, align 8, !tbaa !4
  %vfn.i.i.i119 = getelementptr inbounds i8 (%"class.std::ctype"*, i8)*, i8 (%"class.std::ctype"*, i8)** %vtable.i.i.i118, i64 6
  %35 = load i8 (%"class.std::ctype"*, i8)*, i8 (%"class.std::ctype"*, i8)** %vfn.i.i.i119, align 8
  %call.i.i.i120 = call signext i8 %35(%"class.std::ctype"* nonnull align 8 dereferenceable(570) %31, i8 signext 10)
  br label %_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit125

_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_.exit125: ; preds = %if.then.i4.i.i117, %if.end.i.i.i121
  %retval.0.i.i.i122 = phi i8 [ %33, %if.then.i4.i.i117 ], [ %call.i.i.i120, %if.end.i.i.i121 ]
