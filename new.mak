...
test: build tests/test.cpp BBProfiler/profileInfo.txt 
	...
	$(BUILD_PATH)/opt -load-pass-plugin=build/HPSSA_new.cpp.so -passes=hpssa_new -S -f -time-passes IR/LL/test_mem2reg.ll -o IR/LL/test_HPSSA_new.ll 2> output/custom_HPSSA_new.log
	...
	diff IR/LL/test_mem2reg.ll IR/LL/test_HPSSA_new.ll > output/changes_HPSSA_new.log; [ $$? -eq 1 ]
