...
\begin{frame}[fragile]
	...
	\fbox{Basic blocks from the transformed IR after the \texttt{SpecSCCP} pass with \texttt{assignSpecValue()} calls added.}
	\begin{minted}[fontsize=\tiny, tabsize=2, linenos, highlightlines={4,5,16,17}, escapeinside=||]{css}
		...
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item \fcolorbox{blue}{white}{\mintinline[]{css}{HPSSAPass::AllocateArgs(BasicBlock* BB, DomTreeNode& DTN)}} handles argument allocation for $\tau$-functions inserted.
		\end{itemize}
	\end{itemize}
\end{frame}
