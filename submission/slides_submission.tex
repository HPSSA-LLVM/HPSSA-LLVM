...
int main() {
	...
	\end{columns}
	\vspace{1pt}
	\fbox{Legends \textcolor{pink}{$\blacksquare$} Overdefined  \textcolor{aquamarine}{$\blacksquare$} Discovered Constants \textcolor{yellow}{$\blacksquare$} Real Constants
...
\begin{frame}{SSA Form}
	...
	\includegraphics[width=8.3cm, height=8.35cm]{dotfiles/baseline.dot.pdf}
\end{frame}

\begin{frame}{Hot Path SSA Form}
	\centering
	% HOT PATH SSA PICTURE. HOT PATH SSA, HPSSA 
	\includegraphics[width=9cm, height=8.95cm]{dotfiles/afterHPSSA.dot.pdf}
\end{frame}
