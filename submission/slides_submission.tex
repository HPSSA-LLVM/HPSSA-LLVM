...
int main() {
	...
	return 0;
		...
		\end{column}
	\end{columns}
	\fbox{Legends \textcolor{pink}{$\blacksquare$} Overdefined  \textcolor{aquamarine}{$\blacksquare$} Analysis proved Constants \textcolor{yellow}{$\blacksquare$} Real Constants
...
Output:
	...
	\end{column}
	\begin{column}{0.5\textwidth}  
		\begin{minted}[fontsize=\tiny, tabsize=2, linenos, highlightcolor=aquamarine, highlightlines={3,13}]{c}
...
Output :
	...
	(TauState) tau3 : speculative constantrange<7, 8> 
	...
	Constant: i32 2 =   %mul = mul nsw i32 2, 1
	Constant: i32 7 =   %add = add nsw i32 2, 5
	Constant: i32 2 =   %mul2 = mul nsw i32 2, 1
...
\begin{frame}
	...
	\centering
	\includegraphics[width=11cm, height=8.3cm]{dotfiles/specSCCP_HPSSA.pdf}
\end{frame}
...
\begin{frame}{SSA Form}
	...
	\includegraphics[width=9cm,height=8.2cm]{baseline.pdf}
\end{frame}

\begin{frame}{Hot Path SSA Form}
	\centering
	%Before and After HPSSA CFG, Tau Insert points and calls highlighted.
	\includegraphics[width=8.6cm,height=8cm]{afterHPSSA.pdf}
\end{frame}
