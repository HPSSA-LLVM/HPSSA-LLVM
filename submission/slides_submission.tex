...
{
	\setbeamercolor{background canvas}{bg=}
	\includepdf[pages={17,18}]{summary.pdf}
}
\begin{frame}[fragile]
	\frametitle{... but it is easy with the Hot Path SSA (HPSSA) Form!}
	\begin{columns}
		\begin{column}{0.5\textwidth}
	\begin{minted}[xleftmargin=1em, tabsize=2, numbersep=0.5em, fontsize=\tiny, linenos, highlightcolor=yellow, highlightlines={1}]{cpp}
